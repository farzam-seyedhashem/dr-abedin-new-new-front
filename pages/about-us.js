...
export default function Home(props) {
    ...
    const drFeatures = [
        ...
        "فارغ التحصيل دوره تخصصي گوش، حلق، بيني و جراحي سر و گردن از دانشگاه علوم پزشكي شهيد بهشتي در سال ١٣٩١",
            ...
            <div className={"px-4 md:px-6 pt-6"}>
                ...
                <div className={"mt-16 container mx-auto"}>
                    ...
                    <Typography className={"text-on-surface-light dark:text-on-surface-dark mb-4"} type={"p"}>
                        {"دکتر بهزاد عابدین متولد ١٣٦١ در تهران، داراي درجه دانشنامه (بورد تخصصي)، عضو انجمن گوش، حلق، بيني و جراحان سر و گردن ايران و عضو انجمن راینولوژی ایران مي باشند. ايشان فارغ التحصيل دوره پزشكي عمومي از دانشگاه علوم پزشكي ايران در سال ١٣٨٧ با رتبه برتر و فارغ التحصيل دوره تخصصي گوش، حلق، بيني و جراحي سر و گردن از دانشگاه علوم پزشكي شهيد بهشتي در سال ١٣٩١ می باشند."}
                    </Typography>
                    ...
                    <Typography className={"text-on-surface-light dark:text-on-surface-dark mb-4"} type={"p"}>
                        {"این وب سایت، سايت رسمی دکتر بهزاد عابدین جراح و متخصص گوش، حلق، بيني و جراح پلاستيك بيني و صورت مي باشد و در آن توضیحاتی در مورد جراحي پلاستیک بینی و همچنین خدمات این جراح (دکتر بهزاد عابدین) وجود دارد. بازديد كنندگان از سايت می توانند با مطالعه این بخش ها اطلاعات مورد نیاز خود را جهت جراحی زیبایی بینی به دست بیاورند و یا برای دریافت وقت مشاوره و نوبت گیری جهت انجام جراحی پلاستیک بینی و صورت و معاينات گوش و حلق و بيني در این وبسایت از طریق بخش نوبت دهی آنلاین از دکتر بهزاد عابدین اقدام نمايند."}
                    </Typography>
                    <Typography type={"p"} className={"text-on-surface-light dark:text-on-surface-dark "}>
                        {"دکتر بهزاد عابدین با بيش از ۱۲ سال سابقه در جراحي بيني بالغ بر ۴۵۰۰ مورد رينوپلاستي انجام داده اند و شما مي توانيد از طریق اين سايت نسبت به مشاهده تصاوير مربوط به جراحي هاي انجام شده توسط ايشان و دریافت نوبت به صورت آنلاین براي مشاوره در مورد جراحی پلاستیک بینی و صورت و دیگر خدمات ارائه شده از دکتر بهزاد عابدین اقدام فرماييد و همچنين اطلاعات علمي و كاربردي مفيدي در خصوص اصول و شرايط جراحي بيني، مراقبتهاي بعد از جراحي و پاسخ به بسياري از سوالات و ابهامات خود در اين خصوص را دريافت نماييد."}
                    </Typography>
                    <h2 id={"h3"}
                        className="-mt-8  pt-24 mb-8 font-black text-on-surface-light dark:text-on-surface-dark  sm:text-4xl text-title-large">
                        {"تیزر دکتر بهزاد عابدین"}
