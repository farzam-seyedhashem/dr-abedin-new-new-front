...
export default function NavigationBar(props) {
    ...
    const menu = [
        ...
        },
        {
            ...
            icon: ({className}) => {
                return (
                    <Icon type={"outline"} className={`${className}`}>
                        directions_car
                    </Icon>
                )
            },
            iconField: ({className}) => {
                return (
                    <Icon type={"fill"} className={`${className}`}>
                        directions_car
                    </Icon>
                )
            },
    ...
    return (
        <div
            className={"md:hidden fixed z-999 justify-center h-[80px] flex items-center bottom-0 left-0 w-full bg-surface-container-light dark:bg-surface-container-dark pt-3 pb-4"}>
            {menu.map((item, i) =>
                <Link key={i} href={item.href}
                      className={`w-full text-center text-label-medium ${router.pathname === item.href ? "text-on-surface-light dark:text-on-surface-dark" : "text-on-surface-variant-light dark:text-on-surface-variant-dark"}`}>
                    <div
                        className={`${router.pathname === item.href ? "bg-secondary-container-light dark:bg-secondary-container-dark" : ""} w-[64px] mx-auto items-center flex justify-center h-[32px]  rounded-full`}>
                        {router.pathname !== item.href ? <item.icon
                            className={`text-on-surface-variant-light dark:text-on-surface-variant-dark`}/> : <item.iconField
                            className={`text-on-secondary-container-light dark:text-on-secondary-container-dark`}/>}
                    </div>
                    {item.name}
                </Link>
            )}
            <div onClick={()=>setIsOpenBottomSheet(true)}
                className={`w-full text-center text-label-medium ${moreItems.findIndex(item => item.href === router.pathname) !== -1 ? "text-on-surface-light dark:text-on-surface-dark" : "text-on-surface-variant-light dark:text-on-surface-variant-dark"}`}>
                <div
                    className={`${moreItems.findIndex(item => item.href === router.pathname) !== -1 ? "bg-secondary-container-light dark:bg-secondary-container-dark" : ""} w-[64px] mx-auto items-center flex justify-center h-[32px]  rounded-full`}>
                    {moreItems.findIndex(item => item.href === router.pathname) !== -1  ?
                        <Icon className={`text-on-surface-variant-light dark:text-on-surface-variant-dark`} type={"outline"}>more_horiz</Icon> : <Icon
                            className={`text-on-secondary-container-light dark:text-on-secondary-container-dark`} type={"fill"}>more_horiz</Icon>}
                </div>
                More
            </div>
            <BottomSheet isOpen={isOpenBottomSheet} setIsOpen={setIsOpenBottomSheet}>
                <ul className={"px-3 pb-4"}>
                    ...
                    <li key={index}>
                        <Link href={item.href} className={`${router.pathname === item.href ? "text-on-secondary-container-light dark:text-on-secondary-container-dark bg-secondary-container-light dark:bg-secondary-container-dark" : ""} pr-4 items-center text-body-large text-on-surface-light dark:text-on-surface-dark flex pl-6 py-2 h-[48px] w-full rounded-full`}>
                            {item.name}
                        </Link>
                    </li>
                    )}
